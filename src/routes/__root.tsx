...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Raise complaints, track resolutions, and stay informed. A transparent maintenance and communication platform for apartment societies and gated communities." },
      { property: "og:title", content: "Society Maintenance Tracker" },
      { property: "og:description", content: "Modern maintenance operations for residential communities." },
